...
# 3단계: 전입예정확인서
    ...
    if st.button("✒️다음 단계로"):
        ...
        try:
            ...
            transfer_positions = {
                "{{student_name}}": [(462, 457), (825, 1750)],
                "{{parent_name}}": [(1125, 457), (825, 1875)],
                "{{student_school}}": [(440, 555)],
                "{{relationship}}": [(1125, 555)],
                "{{student_phone}}": [(462, 650)],
                "{{parent_phone}}": [(1125, 650)],
                "{{move_date}}": [(462, 847)],
                "{{address}}": [(1125, 830), (670, 1210)],
                "{{school_name}}": [(462, 1090), (300, 1270), (930, 2040)],
                "{{next_grade}}": [(1125, 1090), (860, 1270)],
