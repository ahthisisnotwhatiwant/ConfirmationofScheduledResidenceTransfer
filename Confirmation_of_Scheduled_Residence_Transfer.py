...
# 사용자 안내
st.markdown('<div class="instruction-message">📢 목적 📢<br> 신설학교 학급 편성을 위한 정보 수집<br> 📌 순서 📌<br> 지역 및 학교 선택 → 개인정보 수집·이용 동의서 및 정보 작성 → 제출</div>', unsafe_allow_html=True)
    ...
    if st.button("✒️다음 단계로"):
        ...
        try:
            ...
            transfer_positions = {
                ...
                "{{school_name}}": [(462, 1048), (240, 1245), (937, 2057)],
                "{{next_grade}}": [(1115, 1048), (840, 1245)],
                "{{date.today}}": [(975, 1610)],
...
# 4단계: 미리보기 및 제출
    ...
    st.markdown('<div class="instruction-message">제출할 전입예정확인서를 미리 확인 후 최종 제출해 주세요.</div>', unsafe_allow_html=True)
