...
# 3단계: 전입예정확인서
    ...
    if st.button("✒️다음 단계로"):
        ...
        try:
            ...
            transfer_positions = {
                "{{student_name}}": [(462, 430), (825, 1750)],
                "{{parent_name}}": [(1125, 440), (825, 1875)],
                "{{student_school}}": [(440, 605)],
                "{{relationship}}": [(1125, 555)],
                "{{student_phone}}": [(462, 680)],
                "{{parent_phone}}": [(1125, 670)],
                "{{move_date}}": [(462, 880)],
                "{{address}}": [(1125, 880), (600, 1210)],
                "{{school_name}}": [(462, 1080), (300, 1270), (930, 2040)],
                "{{next_grade}}": [(1125, 1080), (860, 1270)],
